    ...
    <section class="services-container">
        ...
        <div class="service-box">
            <a href="pdfs.php"> <!-- Link to the PDF Files page -->
                <h2 class="service-title">PDF Files</h2> <!-- Title for the PDF Files service -->
                <p class="service-subtitle">Access educational resources</p> <!-- Subtitle to explain the service -->
                <p class="service-description">Browse a collection of Islamic PDF documents.</p> <!-- Short description of the service -->
            </a>
        </div>
    </section>
