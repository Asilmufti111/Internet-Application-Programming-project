...
-->
<?php
$page_title = "Islamic Educational Videos";
$page_description = "Watch and learn from Islamic scholars and Quran recitations.";
?>
...
<head>
    ...
    <title>Islamic Videos - Al-Noor</title>
        ...
        <section class="content">
            ...
            <div class="video-container">
                <iframe width="560" height="315" 
                        ...
                        title="The History of the Entire Islamic Civilization" 
                        allowfullscreen></iframe>
